<template>
        ...
        <input type="password" class="form-control" id="pass1" required v-model="form.password">
    </div>
    <div class="form-group left">
        <label for="">Vuelve a escribir la Contraseña</label>
        <input type="password" class="form-control" id="pass2" required v-model="password2" >
    </div>
